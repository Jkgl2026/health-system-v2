...
import { LogOut, ArrowLeft, Activity, Users, CheckCircle, TrendingUp, TrendingDown, Minus, Eye, HelpCircle, AlertCircle, FileText, Sparkles, Flame, Heart, Zap, Droplets, Target, BookOpen, Stethoscope, RefreshCw, XCircle, CheckCircle2, AlertTriangle, Lightbulb, PlusCircle, MinusCircle, ArrowRight, ArrowDown, Clock, Shield, X } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">对比 {compareData.length} 个版本的完整数据</p>
              </div>
              <Button variant="ghost" size="sm" onClick={() => setShowCompareDialog(false)}>
                <X className="h-6 w-6" />
              </Button>
            </div>
                        ...
                        return (
                          <div key={index} className="flex items-start gap-2 mb-2">
                            {analysis.diff > 0 ? (
                              ...
                              <Minus className="h-4 w-4 mt-0.5 text-gray-400" />
                            )}
                            <div className="flex-1">
