...
export default function UserDetailHorizon({ user, open, onOpenChange }: UserDetailHorizonProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-[2260px] max-h-[95vh] overflow-y-auto p-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <DialogHeader className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 -mx-16 -mt-16 px-16 py-12 sticky top-0 z-50 shadow-2xl">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-7xl font-bold text-white tracking-wide">用户健康档案</DialogTitle>
              <div className="text-3xl text-white/90 mt-4 font-medium">
            ...
            <Button
              variant="outline"
              size="lg"
              className="bg-white/25 text-white border-white/40 hover:bg-white/35 text-3xl px-12 py-8 shadow-xl"
          ...
          <div className="space-y-12 mt-16">
            ...
            <div className="grid grid-cols-6 gap-12">
              ...
              <div className="col-span-2">
                <Card className="h-full p-10 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-2xl border-4 border-blue-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-blue-800">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-6">
                      <div className="bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                        <div className="text-2xl text-gray-600 mb-3 font-semibold">姓名</div>
                        <div className="text-4xl font-bold text-gray-900">{user.user?.name || '-'}</div>
                      </div>
                      <div className="bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                        <div className="text-2xl text-gray-600 mb-3 font-semibold">年龄</div>
                        <div className="text-4xl font-bold text-gray-900">{user.user?.age || '-'}岁</div>
                      </div>
                      <div className="bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                        <div className="text-2xl text-gray-600 mb-3 font-semibold">性别</div>
                        <div className="text-4xl font-bold text-gray-900">{user.user?.gender || '-'}</div>
                      </div>
                      <div className="bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                        <div className="text-2xl text-gray-600 mb-3 font-semibold">BMI</div>
                      ...
                      <div className="col-span-2 bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg flex gap-6">
                        <div className="flex-1">
                          <div className="text-2xl text-gray-600 mb-3 font-semibold">身高</div>
                          <div className="text-4xl font-bold text-gray-900">{user.user?.height || '-'}cm</div>
                        </div>
                        <div className="flex-1">
                          <div className="text-2xl text-gray-600 mb-3 font-semibold">体重</div>
                          <div className="text-4xl font-bold text-gray-900">{user.user?.weight || '-'}kg</div>
                        </div>
                      </div>
                      <div className="col-span-2 bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                        <div className="text-2xl text-gray-600 mb-3 font-semibold">联系电话</div>
                        <div className="text-4xl font-bold text-gray-900">{user.user?.phone || '-'}</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="col-span-1">
                <Card className="h-full p-10 bg-gradient-to-br from-green-50 to-emerald-100 shadow-2xl border-4 border-green-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-green-800">
                  ...
                  <CardContent className="flex flex-col justify-center h-full">
                    {healthData ? (
                      <div className="text-center">
                        <div className="bg-white p-8 rounded-3xl border-4 border-green-300 shadow-2xl mb-6">
                          <div className="text-3xl font-bold text-green-700 mb-4">综合评分</div>
                          <div className="text-9xl font-black text-green-600 mb-4">{healthData.healthScore}</div>
                          <div className="text-3xl font-semibold text-green-700">分</div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white p-4 rounded-xl border-3 border-blue-200">
                            <div className="text-xl text-gray-600 mb-2">症状总数</div>
                            <div className="text-5xl font-bold text-blue-700">{healthData.totalSymptoms}</div>
                          </div>
              ...
              {/* 健康状况全面解析（占1列） */}
              <div className="col-span-1">
                <Card className="h-full p-10 bg-gradient-to-br from-purple-50 to-violet-100 shadow-2xl border-4 border-purple-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-purple-800">
                  ...
                  <CardContent>
                    {healthData ? (
                      <div className="space-y-6">
                        <div className="bg-white p-6 rounded-2xl border-3 border-purple-300 shadow-lg">
                          <div className="text-2xl text-gray-700 mb-3 font-bold">风险等级</div>
                          <div className={`text-5xl font-bold ${healthData.healthScore >= 80 ? 'text-green-600' : healthData.healthScore >= 60 ? 'text-yellow-600' : 'text-red-600'}`}>
                            {healthData.healthScore >= 80 ? '低风险' : healthData.healthScore >= 60 ? '中等风险' : '高风险'}
                          </div>
                        </div>
                        <div className="bg-white p-6 rounded-2xl border-3 border-blue-300 shadow-lg">
                          <div className="text-2xl text-gray-700 mb-3 font-bold">风险因素</div>
                          <div className="text-3xl font-bold text-blue-700">
                            {healthData.totalSymptoms} 个症状
                          </div>
                        </div>
                        <div className="bg-white p-6 rounded-2xl border-3 border-green-300 shadow-lg">
                          <div className="text-2xl text-gray-700 mb-3 font-bold">首要建议</div>
                          <div className="text-xl text-green-700 font-semibold leading-relaxed">
              ...
              {/* 健康改善路径（占1列） */}
              <div className="col-span-1">
                <Card className="h-full p-10 bg-gradient-to-br from-orange-50 to-amber-100 shadow-2xl border-4 border-orange-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-orange-800">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-white p-5 rounded-2xl border-l-8 border-green-500 border-3 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white text-2xl font-bold">1</div>
                          <div className="text-2xl font-bold text-green-900">紧急处理</div>
                        </div>
                        <div className="text-xl text-gray-700">优先处理严重症状</div>
                      </div>
                      <div className="bg-white p-5 rounded-2xl border-l-8 border-yellow-500 border-3 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center text-white text-2xl font-bold">2</div>
                          <div className="text-2xl font-bold text-yellow-900">习惯改善</div>
                        </div>
                        <div className="text-xl text-gray-700">改正不良习惯</div>
                      </div>
                      <div className="bg-white p-5 rounded-2xl border-l-8 border-blue-500 border-3 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white text-2xl font-bold">3</div>
                          <div className="text-2xl font-bold text-blue-900">身体调理</div>
                        </div>
                        <div className="text-xl text-gray-700">全面调理身体</div>
                      </div>
                      <div className="bg-white p-5 rounded-2xl border-l-8 border-purple-500 border-3 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white text-2xl font-bold">4</div>
                          <div className="text-2xl font-bold text-purple-900">持续跟踪</div>
                        </div>
                        <div className="text-xl text-gray-700">定期检查记录</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              {/* 中医深入分析（占1列） */}
              <div className="col-span-1">
                <Card className="h-full p-10 bg-gradient-to-br from-pink-50 to-rose-100 shadow-2xl border-4 border-pink-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-pink-800">
                    ...
                    {tcmData ? (
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white p-5 rounded-2xl border-3 border-pink-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-pink-700">{tcmData.constitution.type}</div>
                        </div>
                        <div className="bg-white p-5 rounded-2xl border-3 border-red-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-red-700">{tcmData.qiBloodStatus.type}</div>
                        </div>
                        <div className="bg-white p-5 rounded-2xl border-3 border-purple-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-purple-700">阴阳两虚</div>
                        </div>
                        <div className="bg-white p-5 rounded-2xl border-3 border-blue-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-blue-700">督脉不畅</div>
                        </div>
                        <div className="bg-white p-5 rounded-2xl border-3 border-green-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-green-700">寒湿内盛</div>
                        </div>
                        <div className="bg-white p-5 rounded-2xl border-3 border-yellow-300 shadow-lg">
                          ...
                          <div className="text-3xl font-bold text-yellow-700">舌淡苔白</div>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center text-gray-500 text-3xl font-semibold">
            ...
            <div className="grid grid-cols-6 gap-12">
              {/* 健康七问V2（占2列） */}
              <div className="col-span-2">
                <Card className="h-full p-10 bg-gradient-to-br from-teal-50 to-cyan-100 shadow-2xl border-4 border-teal-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-teal-800">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-6">
                      {SEVEN_QUESTIONS.slice(0, 6).map((q, i) => {
                        ...
                        return (
                          <div key={q.id} className={`p-6 rounded-2xl border-3 shadow-lg ${isAnswered ? 'bg-white border-green-400' : 'bg-gray-50 border-gray-300'}`}>
                            ...
                            <div className={`text-3xl font-bold ${isAnswered ? 'text-green-700' : 'text-gray-400'}`}>
                              {isAnswered ? '✓ 已回答' : '✗ 未回答'}
                            </div>
                          </div>
                        );
              ...
              {/* 推荐调理产品（占2列） */}
              <div className="col-span-2">
                <Card className="h-full p-10 bg-gradient-to-br from-indigo-50 to-blue-100 shadow-2xl border-4 border-indigo-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-indigo-800">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-6">
                      <div className="bg-white p-8 rounded-2xl border-3 border-blue-300 shadow-xl hover:shadow-2xl transition-shadow">
                        ...
                        <div className="text-3xl font-bold text-blue-900 mb-4">气血调理包</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-green-300 shadow-xl hover:shadow-2xl transition-shadow">
                        ...
                        <div className="text-3xl font-bold text-green-900 mb-4">排毒养颜包</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-orange-300 shadow-xl hover:shadow-2xl transition-shadow">
                        ...
                        <div className="text-3xl font-bold text-orange-900 mb-4">经络疏通包</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-purple-300 shadow-xl hover:shadow-2xl transition-shadow">
                        ...
                        <div className="text-3xl font-bold text-purple-900 mb-4">滋阴补肾包</div>
              ...
              {/* 推荐学习课程（占2列） */}
              <div className="col-span-2">
                <Card className="h-full p-10 bg-gradient-to-br from-rose-50 to-pink-100 shadow-2xl border-4 border-rose-200">
                  <CardHeader className="pb-6">
                    <CardTitle className="text-4xl font-bold flex items-center gap-4 text-rose-800">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="bg-white p-8 rounded-2xl border-3 border-indigo-300 shadow-xl hover:shadow-2xl transition-shadow">
                        <div className="flex items-center justify-between mb-4">
                          <div className="text-3xl font-bold text-indigo-900">中医养生基础</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-teal-300 shadow-xl hover:shadow-2xl transition-shadow">
                        <div className="flex items-center justify-between mb-4">
                          <div className="text-3xl font-bold text-teal-900">食疗养生课</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-rose-300 shadow-xl hover:shadow-2xl transition-shadow">
                        <div className="flex items-center justify-between mb-4">
                          <div className="text-3xl font-bold text-rose-900">经络推拿课</div>
                      ...
                      <div className="bg-white p-8 rounded-2xl border-3 border-amber-300 shadow-xl hover:shadow-2xl transition-shadow">
                        <div className="flex items-center justify-between mb-4">
                          <div className="text-3xl font-bold text-amber-900">情志调理课</div>
              ...
              <Card className="p-12 bg-gradient-to-br from-green-50 to-emerald-100 shadow-2xl border-4 border-green-200">
                ...
                <CardContent>
                  <div className="bg-white p-8 rounded-3xl border-3 border-green-300 shadow-xl mb-6">
                    <div className="text-3xl font-bold text-green-900 mb-4">调理周期：1-2个月</div>
              ...
              <Card className="p-12 bg-gradient-to-br from-yellow-50 to-amber-100 shadow-2xl border-4 border-yellow-200">
                ...
                <CardContent>
                  <div className="bg-white p-8 rounded-3xl border-3 border-yellow-300 shadow-xl mb-6">
                    <div className="text-3xl font-bold text-yellow-900 mb-4">调理周期：3-4个月</div>
                    <div className="space-y-5">
                      <div className="flex items-start gap-4">
              ...
              <Card className="p-12 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-2xl border-4 border-blue-200">
                ...
                <CardContent>
                  <div className="bg-white p-8 rounded-3xl border-3 border-blue-300 shadow-xl mb-6">
                    <div className="text-3xl font-bold text-blue-900 mb-4">调理周期：5-6个月</div>
                    <div className="space-y-5">
                      <div className="flex items-start gap-4">
            ...
            <Card className="p-12 bg-gradient-to-br from-red-50 to-orange-100 shadow-2xl border-4 border-red-200">
              <CardHeader className="pb-8">
                <CardTitle className="text-5xl font-bold flex items-center gap-6 text-red-800">
                ...
                <div className="grid grid-cols-8 gap-6 max-h-[600px] overflow-y-auto p-8 bg-white rounded-3xl border-4">
                  {allBadHabits.map((habit) => (
                    ...
                    >
                      ...
                      <div className="line-clamp-2 leading-tight text-2xl font-semibold">{habit.habit}</div>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <Card className="p-12 bg-gradient-to-br from-blue-50 to-cyan-100 shadow-2xl border-4 border-blue-200">
              <CardHeader className="pb-8">
                <CardTitle className="text-5xl font-bold flex items-center gap-6 text-blue-800">
                ...
                <div className="grid grid-cols-8 gap-6 max-h-[600px] overflow-y-auto p-8 bg-white rounded-3xl border-4">
                  {BODY_SYMPTOMS.map((symptom) => (
                    ...
                    >
                      ...
                      <div className="line-clamp-2 leading-tight text-2xl font-semibold">{symptom.name}</div>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <Card className="p-12 bg-gradient-to-br from-purple-50 to-violet-100 shadow-2xl border-4 border-purple-200">
              <CardHeader className="pb-8">
                <CardTitle className="text-5xl font-bold flex items-center gap-6 text-purple-800">
                  <FileText className="w-16 h-16" />
                  300项症状自检表（全部300项）
                </CardTitle>
              </CardHeader>
